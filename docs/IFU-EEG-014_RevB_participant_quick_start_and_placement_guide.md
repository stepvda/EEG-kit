...
**Governing documents:** DSN-EEG-003 Rev D, then RFQ-EEG-001 Rev E, and TST-EEG-004 Rev C for every test-step number cited here. Where this document and `tools/design.py` or `tools/mech_gen.py` disagree, the source files govern.

...
| C | 2026-09-08 | **The routing does not stand.** A layout engineer read the Rev B board between 3 and 5 September 2026, declined the review and advised a redesign; **Rev B is withdrawn from fabrication and Rev C is unrouted**, with its placement and routing bought (ECO-EEG-030). Section 0.2 is restated to say so. The fixtures are unaffected in substance -- they are built against connector positions and net names, and neither moved -- but **there is no bare board to build them against and none can be ordered.** Six of the seven findings were rules the DRC did not have; regraded under them the same Rev B geometry shows 1 311 occurrences (ECO-EEG-032). No fixture has been built or measured. |

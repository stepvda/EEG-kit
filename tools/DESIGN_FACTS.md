...
preferences, and DSN-EEG-003 Rev D section 3 explains why. The enclosure grew with the board.
...
|---|---|
| DSN-EEG-003 Rev D | manufacturing design package — architecture, carrier, precedence (**governing**) |
...
| ICD-EEG-006 Rev C | interface control: every module pinout and jumper |
...
| JIG-EEG-009 Rev C | test fixture design, FIX-01 to FIX-04 |
...
| ECO-EEG-016 Rev C | change control and document register — **section 1.1 is the controlled list** |
| AVL-EEG-017 Rev C | approved vendor list |
| SIM-EEG-018 Rev A | end-to-end production simulation report (generated by `tools/simulate_production.py`; never edited by hand) |
| FW-EEG-001 Rev D | firmware build and provisioning, host tool, key fingerprint |
| MECH-EEG-020 Rev A | dimensioned drawings of every printed part (generated) |
| RUL-EEG-021 Rev B | rulings register: one answer to each cross-document disagreement, cited by section letter |

Precedence, highest first: DSN-EEG-003 Rev D → RFQ-EEG-001 Rev E → ICD-EEG-006 Rev C →
...
RUL-EEG-021 Rev B, the rulings register governs.

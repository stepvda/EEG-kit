...
ALLOW = [
    ...
    ("PKG-EEG-015_RevB_packing_labelling_and_shipping.md", "AVL-EEG-017 Rev C K21 restates",
    ...
    ("AVL-EEG-017_RevC_approved_vendor_list.md", "a gain that moves is not a gain",
     "the passage that argues the MAX9814 out; AVL is where the rejection is reasoned"),
    ("JIG-EEG-009_RevC_test_fixture_design.md", "Rev B of this document reported it as",
